...
<h4>Booking ID</h4>
<p><span>DBYB4488</span></p>

    </div>
    <div className={Styles.BookOut}>
<div className={Styles.BookBtn}> <button onClick={handlePrint}>Print</button></div>
...
<div className={Styles.CapriBoat}>
    ...
    <div className={Styles.CapriImg}>
        <div className={Styles.CapriControlImg}><img src='/package/CapriBoat.png'/></div>
    </div>
