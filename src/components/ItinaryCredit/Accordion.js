...
const Accordion = () => {
  ...
  return (
    <div className={styles.accordion}>
      <div className={`${styles.title} ${styles.borderRad} ${activeIndex === 0 ? styles.active : ''}`} onClick={() => onTitleClick(0)}>
...
<div className={styles.creditInput}>
    <div>
    <label>Card Holder Name<span className={styles.HashRed}>*</span></label><br/>
    <input placeholder='Card holder name' required></input>
    </div>

    <div>
    <label>Credit/Debit Card Number<span className={styles.HashRed}>*</span></label><br/>
    <input placeholder='Card number' required></input>
    </div>

    <div>
    <div><label>Expiry Date<span className={styles.HashRed}>*</span></label><br/>
    <input placeholder='MM/YY' required></input></div>

    <div><label>CVC/CVV<span className={styles.HashRed}>*</span></label><br/>
    <input placeholder='MM/YY' required></input></div>
    </div>
</div>
<div  className={styles.creditOut}>
    <div>
    <img src="/package/CreditCard.png" />
    </div>
</div>
